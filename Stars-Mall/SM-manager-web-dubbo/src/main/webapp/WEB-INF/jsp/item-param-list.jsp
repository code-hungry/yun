...
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/js/jquery-easyui-1.4.1/locale/easyui-lang-zh_CN.js"></script>
<table class="easyui-datagrid" id="itemParamList" title="商品规格参数列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'created',width:130,align:'center',formatter:HG.formatDateTime">创建日期</th>
            <th data-options="field:'updated',width:130,align:'center',formatter:HG.formatDateTime">更新日期</th>
        </tr>
    </thead>
</table>
...
<script>
    ...
    var itemParamListToolbar = [{
        ...
        iconCls:'icon-cancel',
        handler:function(){
        	var ids = getSelectionsIds();//收集选中的模板规格参数id
        	if(ids.length == 0){
